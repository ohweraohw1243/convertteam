...
def export_to_google_sheets(rows: list[dict]):
    ...
    # Заголовок для новых строк. При первом запуске его можно закомментировать/раскомментировать.
    # ws.append_row(["Дата", "Проект", "Показы", "Клики", "CTR", "Расход", "CPC", "Конверсии (Директ)", "Цена конв.", "Сессии (Метрика)", "Отказы", "CR"])
